...
$pdf->AddPage();
$pdf->Image('http://localhost/Proyecto_zapateria/assets/img/logo_fact.png',10,10,50);
$pdf->addSociete( utf8_decode("Sistema Zapatería UMG"),
...
$pdf->addClient("CL01");
$pdf->addPageNumber("1");
$pdf->addClientAdresse(utf8_decode("Nombre: PROYECTO UMG\nDirección: 5TA. Av. 5-32 zona 5 san miguel morazán\nTelefono: 30394319\nNIT: 9652562-3"));
